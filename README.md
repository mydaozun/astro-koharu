...
- 图片加载前显示渐变色占位，提升视觉体验 - [介绍文章](https://bk.52cbg.cn/post/astro-lqip-implementation)
...
- Markdown 增强 - 链接嵌入功能 - [示例](https://bk.52cbg.cn/post/my-claude-code-record-2)
...
- 有样式的 RSS 订阅源链接 - [示例](https://bk.52cbg.cn/rss.xml)
